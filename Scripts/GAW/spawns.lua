...
ArcoSpawn:OnSpawnGroup(function(grp)
    ...
    WeatherPositioning.avoidCloudLayer(grp, ArcoSpawn.MEName, 144) -- Init against cloud base at 144 m/s (280 knots)
end)
--
...
--addition
--WizardSpawn = Spawner("Wizard_249")
--WizardSpawn:OnSpawnGroup(function(grp)
--    scheduledSpawns[grp:getUnit(1):getName()] = {WizardSpawn, 600}
--end)
--
