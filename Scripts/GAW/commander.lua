...
max_caps_for_player_count = function(players) --edited
    if players == 1 then
    ...
    if players < 3 then
        caps = 1
    elseif players >= 3 and players < 4 then --new line
        caps = 1
    elseif players >= 4 and players < 8 then
        caps = 2
    elseif players >= 8 and players < 12 then
        caps = 4
    elseif players >= 12 and players < 28 then
        caps = 6
    else
        caps = 1
    end
