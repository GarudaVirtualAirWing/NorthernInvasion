env.setErrorMessageBoxEnabled(false) -- Disable the error popup.
...
if statefile then
    ...
    trigger.action.setUserFlag("Krymsk KA50 1",100)
    trigger.action.setUserFlag("Krymsk F-16 1",100)
    trigger.action.setUserFlag("Krymsk SU27 1",100)
